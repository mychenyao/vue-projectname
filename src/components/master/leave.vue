  ...
  <div id="app">
    ...
    <!--弹框-->
            <el-dialog style="z-index:999999"  :visible.sync="dialogTableVisible" size="tiny">
                  ...
                  <textarea class="alert_forbidden_area" v-model="textareaContent"></textarea>
...
<script>
  import detail from "./bdetail.vue";
  export default {
    components:{
      detail,
    },
...
//        <!--禁用启用start-->
        ...
        sortData: [
          {
            index:4,
            sortAscendingValues:[" start_time asc "],  //升序
            gradeDownValues:[" start_time desc "],     //降序
          },  {
            index:5,
            sortAscendingValues:[" end_time asc "],  //升序
            gradeDownValues:[" end_time desc "],     //降序
          },  {
            index:8,
