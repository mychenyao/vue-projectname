    ...
    <div class="container">
      <div class="selector_list">
        ...
        <div class="list">
          认证状态 :
          <el-select
            v-model="certificateState.SourceTypeValue" placeholder="请选择" @change="selectorArea(certificateState,certificateState.SourceType,certificateState.SourceTypeValue)">
            <el-option
