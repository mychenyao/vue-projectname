<template>
  ...
  <div id="app">
    ...
    <!--//改约时间-->
    <changTime :time="time" :findOne="quiry"></changTime>
    <!--//改约时间den-->
    ...
    methods: {
      ...
      quiry(){
        ...
        if(this.timeQuantum2.length>0) {
          this.statisticsDateStartStr2 = this.$moment(this.timeQuantum2[0]).format('YYYY-MM-DD 00:00:00');
          this.statisticsDateEndStr2 = this.$moment(this.timeQuantum2[1]).format('YYYY-MM-DD 23:59:59');
        }
