    ...
    <div v-show="orderDetailed.isShow" class="container">
      ...
      <div class="selector_list">
        <div class="list">
          ...
          <el-input
            placeholder="请输入内容"
            v-model="inputParams.mainOrderId">
          </el-input>
        </div>
        <div class="list">
          返修工单号 :
...
//table 数据 start;
      getTableList(params){
        let url=common.apidomain+"/orderquery/findnewpage";
